...
func setupRoutes(router *gin.Engine) {
	...
	{ // Calendars
		...
		calendars.GET("/:calendar_id/ical", controllers.LoggedIn, controllers.GetCalendarICal)   // Get a specific calendar
...
func CORSMiddleware() gin.HandlerFunc {
	return func(c *gin.Context) {
		c.Writer.Header().Set("Access-Control-Allow-Origin", "http://localhost, http://127.0.0.1, http://localhost:8081, http://127.0.0.1:8081")
